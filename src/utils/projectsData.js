export const projectData = [
  ...
  //Project 3
  {
    ...
    technologies: "WEBPACK, JavaScript, HTML",
  ...
  //Project 4
  {
    ...
    technologies:
      "Handlebars, JavaScript, CSS, HTML, Bootstrap, MySQL, Sequelize",
  ...
  //Project 9
  {
    ...
    description:
      "This project consists of a code refactor. The application is a Google Books API search engine that was built with RESTfull API and it was refactored to use GraphQL API built with Apollo Server. Book search engine enables the user to search for books and save them on their own page. Once a book is searched, the user can see the book's title, author, description, image and a link to that book on the Google Books site.",
    technologies:
